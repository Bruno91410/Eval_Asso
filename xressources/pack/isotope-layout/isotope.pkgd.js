...
(function (window, factory) {
  ...
  // cache all pack properties that could have pack prefix
  var packProperties = {
  ...
  proto.css = function (style) {
    ...
    for (var prop in style) {
      // use pack property if available
      var supportedProp = packProperties[prop] || prop;
  ...
  proto.ontransitionend = function (event) {
    ...
    var propertyName =
      dashedpackProperties[event.propertyName] || event.propertyName;
