(function (global, factory) {
  ...
  function injectressources(url, waitFor, callback) {
    if (isNil(url)) {
      console.error("Inject ressources error");
      return;
    }
  ...
  function slideVideo(slide, data, index, callback) {
    ...
    injectressources(this.settings.plyr.css, "Plyr");
    var url = data.href;
    ...
    injectressources(this.settings.plyr.js, "Plyr", function () {
